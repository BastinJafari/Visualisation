...
public class ControlMessageVisual extends Circle {
	...
	public ControlMessageVisual(Message message, SimulationVisual simulationVisual) {
		...
		super(simulationVisual.getProcessVisualList().get(message.getStart().getId()).getCenterX(),simulationVisual.getProcessVisualList().get(message.getStart().getId()).getCenterY(), 10);
