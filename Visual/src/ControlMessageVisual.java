...
public class ControlMessageVisual extends Circle {
	...
	public ControlMessageVisual(){}

	public ControlMessageVisual(Message message, SimulationVisual simulationVisual) {
		
		super(simulationVisual.getProcessVisualList().get(message.getSender().getId()).getCenterX(),simulationVisual.getProcessVisualList().get(message.getSender().getId()).getCenterY(), 10);
